...
router.put('/:id', authenticate, (req: Request, res: Response) => {
  ...
  const editFields = ['title', 'description', 'start_date', 'end_date', 'currency', 'reminder_days', 'day_count', 'registration_fee', 'fee_mode', 'fee_deadline', 'rsvp_deadline', 'fee_currency', 'country'];
...
router.get('/:id/bundle', authenticate, (req: Request, res: Response) => {
  ...
  const todoItems = listTodoItems(tripId, authReq.user.id);
