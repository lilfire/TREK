...
7. **Branch up to date** — Your branch must be [up to date with `dev`](https://github.com/lilfire/TREK/wiki/Development-environment#3-keep-your-fork-up-to-date) before submitting a PR
...
See the [Developer Environment page](https://github.com/lilfire/TREK/wiki/Development-environment) for more information on setting up your development environment.

## More Details

See the [Contributing wiki page](https://github.com/lilfire/TREK/wiki/Contributing) for the full tech stack, architecture overview, and detailed guidelines.
