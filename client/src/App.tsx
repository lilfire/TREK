...
export default function App() {
  const { loadUser, isAuthenticated, demoMode, setDemoMode, setDevMode, setIsPrerelease, setAppVersion, setHasMapsKey, setServerTimezone, setAppRequireMfa, setTripRemindersEnabled, setPlacesPhotosEnabled, setPlacesAutocompleteEnabled, setPlacesDetailsEnabled, setPublicMapTileUrl, setGithubRepo } = useAuthStore()
  ...
  useEffect(() => {
    ...
    authApi.getAppConfig().then(async (config: { demo_mode?: boolean; dev_mode?: boolean; is_prerelease?: boolean; has_maps_key?: boolean; version?: string; timezone?: string; require_mfa?: boolean; trip_reminders_enabled?: boolean; places_photos_enabled?: boolean; places_autocomplete_enabled?: boolean; places_details_enabled?: boolean; public_map_tile_url?: string | null; github_repo?: string; permissions?: Record<string, PermissionLevel> }) => {
      ...
      if (config?.public_map_tile_url !== undefined) setPublicMapTileUrl(config.public_map_tile_url ?? null)
