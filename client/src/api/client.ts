...
export const adminApi = {
  ...
  getPublicMapTileUrl: () => apiClient.get('/admin/public-map-tile-url').then(r => r.data),
  updatePublicMapTileUrl: (url: string | null) => apiClient.put('/admin/public-map-tile-url', { url }).then(r => r.data),
