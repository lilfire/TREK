const de: Record<string, string | { name: string; category: string }[]> = {
  ...
  // RSVP form
  'rsvp.onTheList': "Du stehst auf der Liste.",
  'rsvp.viewDashboard': "Reise im Dashboard anzeigen →",
  'rsvp.joining': "Beitreten...",
  'rsvp.joinTrip': "Reise beitreten",
  'rsvp.intro': "Wir erstellen ein TREK-Konto für dich, damit du das vollständige Reiseprogramm abrufen kannst.",
  'rsvp.alreadyHaveAccount': "Bereits ein Konto? Anmelden",
  'rsvp.nameLabel': "Dein Name",
  'rsvp.namePlaceholder': "Dein Name",
  'rsvp.emailLabel': "E-Mail-Adresse",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Ein TREK-Konto wird mit dieser E-Mail-Adresse erstellt.",
  'rsvp.messageLabel': "Nachricht",
  'rsvp.messageOptional': "(optional)",
  'rsvp.messagePlaceholder': "Was soll der Reiseveranstalter wissen...",
  'rsvp.feeLabel': "Anmeldegebühr: {amount} {currency}",
  'rsvp.feeDeadline': "Zahlungsfrist: {date}.",
  'rsvp.feeInstructions': "Zahlungsanweisungen werden nach der Anmeldung vom Reiseveranstalter mitgeteilt.",
  'rsvp.logInHere': "Hier anmelden",
  'rsvp.confirming': "Wird bestätigt...",
  'rsvp.confirmMySpot': "Platz bestätigen",
  'rsvp.nameRequired': "Name ist erforderlich.",
  'rsvp.emailRequired': "E-Mail ist erforderlich.",
  'rsvp.paymentSuccess': "🎉 Du bist dabei! Zahlung von {amount} {currency} bestätigt.",
  'rsvp.paypalFeeNotice': "Anmeldegebühr: {amount} {currency}. Bitte zahle unten, um deinen Platz zu sichern.",
  'rsvp.paymentNotCompleted': "Zahlung wurde nicht abgeschlossen. Deine Anmeldung wurde nicht gespeichert.",
  'rsvp.paymentUnavailable': "Online-Zahlung ist vorübergehend nicht verfügbar. Bitte kontaktiere den Reiseveranstalter zur Anmeldung.",
  'rsvp.toastJoined': "🎉 Du bist dabei! Schau in dein Dashboard für das vollständige Reiseprogramm.",
  'rsvp.toastRegistered': "🎉 Du bist dabei! Willkommen bei TREK — prüfe dein Postfach.",
  'rsvp.error.duplicateRsvp': "Du stehst bereits auf der Liste für diese Reise. Überprüfe dein Postfach.",
  'rsvp.error.emailConflict': "Diese E-Mail ist mit einem TREK-Konto verknüpft. Bitte melde dich an.",
  'rsvp.error.notFound': "Diese Reise nimmt keine Anmeldungen mehr an.",
