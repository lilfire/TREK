const fr: Record<string, string> = {
  ...
  // GitHub
  'admin.version.prerelease': 'Pré-version',
  ...
  // RSVP form
  'rsvp.onTheList': "Tu es sur la liste.",
  'rsvp.viewDashboard': "Voir le voyage dans le tableau de bord →",
  'rsvp.joining': "Inscription...",
  'rsvp.joinTrip': "Rejoindre le voyage",
  'rsvp.intro': "Nous créerons un compte TREK pour vous afin que vous puissiez accéder à l'itinéraire complet.",
  'rsvp.alreadyHaveAccount': "Vous avez déjà un compte ? Connexion",
  'rsvp.nameLabel': "Votre nom",
  'rsvp.namePlaceholder': "Votre nom",
  'rsvp.emailLabel': "Adresse e-mail",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Un compte TREK sera créé avec cette adresse e-mail.",
  'rsvp.messageLabel': "Message",
  'rsvp.messageOptional': "(optionnel)",
  'rsvp.messagePlaceholder': "Ce que l'organisateur doit savoir...",
  'rsvp.feeLabel': "Frais d'inscription : {amount} {currency}",
  'rsvp.feeDeadline': "Date limite de paiement : {date}.",
  'rsvp.feeInstructions': "Les instructions de paiement seront fournies par l'organisateur après votre inscription.",
  'rsvp.logInHere': "Se connecter ici",
  'rsvp.confirming': "Confirmation...",
  'rsvp.confirmMySpot': "Confirmer ma place",
  'rsvp.nameRequired': "Le nom est requis.",
  'rsvp.emailRequired': "L'e-mail est requis.",
  'rsvp.paymentSuccess': "🎉 Vous êtes inscrit ! Paiement de {amount} {currency} confirmé.",
  'rsvp.paypalFeeNotice': "Frais d'inscription : {amount} {currency}. Effectuez le paiement ci-dessous pour confirmer votre place.",
  'rsvp.paymentNotCompleted': "Le paiement n'a pas été complété. Votre inscription n'a pas été enregistrée.",
  'rsvp.paymentUnavailable': "Le paiement en ligne est temporairement indisponible. Veuillez contacter l'organisateur du voyage pour vous inscrire.",
  'rsvp.toastJoined': "🎉 C'est bon ! Consultez votre tableau de bord pour voir l'itinéraire.",
  'rsvp.toastRegistered': "🎉 C'est bon ! Bienvenue sur TREK — vérifiez votre boîte de réception.",
  'rsvp.error.duplicateRsvp': "Vous êtes déjà sur la liste pour ce voyage. Vérifiez votre boîte de réception.",
  'rsvp.error.emailConflict': "Cet e-mail est lié à un compte TREK. Veuillez vous connecter pour réserver.",
  'rsvp.error.notFound': "Ce voyage n'accepte plus les réservations.",
  'rsvp.error.tooManyAttempts': "Trop de tentatives. Veuillez attendre quelques minutes avant de réessayer.",
  'rsvp.error.serverError': "Une erreur s'est produite de notre côté. Veuillez réessayer dans quelques instants.",
  'rsvp.error.unknown': "Une erreur s'est produite. Veuillez réessayer.",
  ...
  'publicTrip.unplanned.subheading': 'Lieux ajoutés à ce voyage mais pas encore planifiés.',

  'places.budgetSelectEntry': 'Select an entry',

  // Public trip page — Accommodation tiers
  'publicTrip.tiers.heading': 'Hébergement',
  'publicTrip.tiers.subheading': "L'hébergement dépend du nombre d'inscrits.",
  'publicTrip.tiers.participants': '{count} confirmés',
  'publicTrip.tiers.nextTier': 'Encore {count} pour débloquer {name}',
  'publicTrip.tiers.allReached': 'Palier maximum atteint !',
  'publicTrip.tiers.paidNote': 'Seules les inscriptions payées comptent.',
  'publicTrip.tiers.active': 'Actuel',
  ...
  'publicTrip.tiers.viewPlace': "Voir l'hébergement",
  'publicTrip.tiers.viewOnMap': "Voir sur la carte",

  // Trip form — Accommodation tiers editor
  'tripForm.tiers.heading': "Paliers d'hébergement",
  'tripForm.tiers.hint': "L'hébergement dépend du nombre de participants confirmés (propriétaire + inscriptions ; seulement payées si des frais s'appliquent). Affiché sur la page publique du voyage.",
  'tripForm.tiers.status': "{count} confirmés",
  'tripForm.tiers.current': "actuel : {name}",
  'tripForm.tiers.add': "Ajouter un palier",
  'tripForm.tiers.name': "Nom",
  'tripForm.tiers.namePlaceholder': "ex. Chalet Fjellro",
  'tripForm.tiers.minParticipants': "À partir de (participants)",
  'tripForm.tiers.place': "Lieu (facultatif)",
  'tripForm.tiers.noPlace': "Aucun lieu",
  'tripForm.tiers.pricePerPerson': "Prix/personne ({currency})",
  'tripForm.tiers.description': "Description (facultative)",
  'tripForm.tiers.nameRequired': "Le nom est obligatoire",
  'tripForm.tiers.minInvalid': "Le nombre de participants doit être un entier ≥ 1",
  'tripForm.tiers.priceInvalid': "Le prix doit être supérieur ou égal à 0",
  'tripForm.tiers.saveError': "Impossible d'enregistrer le palier",
  'tripForm.tiers.deleteError': "Impossible de supprimer le palier",
  'tripForm.tiers.confirmDelete': "Supprimer le palier « {name} » ?",
}
