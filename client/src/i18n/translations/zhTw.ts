const zhTw: Record<string, string> = {
  ...
  // RSVP form
  'rsvp.onTheList': "您已在名單上。",
  'rsvp.viewDashboard': "在控制台查看行程 →",
  'rsvp.joining': "加入中...",
  'rsvp.joinTrip': "加入行程",
  'rsvp.intro': "我們將為您建立一個 TREK 帳號，以便存取完整行程。",
  'rsvp.alreadyHaveAccount': "已有帳號？登入",
  'rsvp.nameLabel': "您的姓名",
  'rsvp.namePlaceholder': "您的姓名",
  'rsvp.emailLabel': "電子郵件地址",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "將使用此電子郵件地址建立 TREK 帳號。",
  'rsvp.messageLabel': "留言",
  'rsvp.messageOptional': "（選填）",
  'rsvp.messagePlaceholder': "您希望主辦方了解的事項...",
  'rsvp.feeLabel': "報名費：{amount} {currency}",
  'rsvp.feeDeadline': "付款截止日期：{date}。",
  'rsvp.feeInstructions': "報名後，主辦方將提供付款說明。",
  'rsvp.logInHere': "在此登入",
  'rsvp.confirming': "確認中...",
  'rsvp.confirmMySpot': "確認我的名額",
  'rsvp.nameRequired': "姓名為必填項。",
  'rsvp.emailRequired': "電子郵件為必填項。",
  ...
  'rsvp.error.emailConflict': "此郵箱已關聯 TREK 帳號，請登入後報名。",
  'rsvp.error.notFound': "此行程已停止接受報名。",
