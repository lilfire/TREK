const id: Record<string, string | { name: string; category: string }[]> = {
  ...
  // RSVP form
  'rsvp.onTheList': "Anda sudah terdaftar.",
  'rsvp.viewDashboard': "Lihat perjalanan di dasbor →",
  'rsvp.joining': "Bergabung...",
  'rsvp.joinTrip': "Ikut Perjalanan",
  'rsvp.intro': "Kami akan membuat akun TREK untuk Anda agar dapat mengakses itinerary lengkap.",
  'rsvp.alreadyHaveAccount': "Sudah punya akun? Masuk",
  'rsvp.nameLabel': "Nama Anda",
  'rsvp.namePlaceholder': "Nama Anda",
  'rsvp.emailLabel': "Alamat email",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Akun TREK akan dibuat menggunakan alamat email ini.",
  'rsvp.messageLabel': "Pesan",
  'rsvp.messageOptional': "(opsional)",
  'rsvp.messagePlaceholder': "Hal yang ingin diketahui oleh penyelenggara...",
  'rsvp.feeLabel': "Biaya pendaftaran: {amount} {currency}",
  'rsvp.feeDeadline': "Batas pembayaran: {date}.",
  'rsvp.feeInstructions': "Instruksi pembayaran akan diberikan oleh penyelenggara perjalanan setelah Anda mendaftar.",
  'rsvp.logInHere': "Masuk di sini",
  'rsvp.confirming': "Mengkonfirmasi...",
  'rsvp.confirmMySpot': "Konfirmasi tempat saya",
  'rsvp.nameRequired': "Nama harus diisi.",
  'rsvp.emailRequired': "Email harus diisi.",
  ...
  'rsvp.error.emailConflict': "Email ini terhubung dengan akun TREK. Silakan masuk untuk mendaftar.",
  'rsvp.error.notFound': "Perjalanan ini sudah tidak menerima pendaftaran.",
  'rsvp.error.tooManyAttempts': "Terlalu banyak percobaan. Tunggu beberapa menit sebelum mencoba lagi.",
  'rsvp.error.serverError': "Terjadi kesalahan di pihak kami. Silakan coba lagi sebentar.",
  'rsvp.error.unknown': "Terjadi kesalahan. Silakan coba lagi.",
