const nl: Record<string, string> = {
  ...
  // RSVP form
  'rsvp.onTheList': "Je staat op de lijst.",
  'rsvp.viewDashboard': "Bekijk de reis in je dashboard →",
  'rsvp.joining': "Aanmelden...",
  'rsvp.joinTrip': "Reis deelnemen",
  'rsvp.intro': "We maken een TREK-account voor je aan zodat je het volledige reisschema kunt bekijken.",
  'rsvp.alreadyHaveAccount': "Heb je al een account? Inloggen",
  'rsvp.nameLabel': "Jouw naam",
  'rsvp.namePlaceholder': "Jouw naam",
  'rsvp.emailLabel': "E-mailadres",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Er wordt een TREK-account aangemaakt met dit e-mailadres.",
  'rsvp.messageLabel': "Bericht",
  'rsvp.messageOptional': "(optioneel)",
  'rsvp.messagePlaceholder': "Iets wat de organisator moet weten...",
  'rsvp.feeLabel': "Inschrijfgeld: {amount} {currency}",
  'rsvp.feeDeadline': "Betalingsdeadline: {date}.",
  'rsvp.feeInstructions': "De betalingsinstructies worden na inschrijving verstrekt door de reisorganisator.",
  'rsvp.logInHere': "Log hier in",
  'rsvp.confirming': "Bevestigen...",
  'rsvp.confirmMySpot': "Bevestig mijn plek",
  'rsvp.nameRequired': "Naam is verplicht.",
  'rsvp.emailRequired': "E-mail is verplicht.",
  ...
  'rsvp.error.emailConflict': "Dit e-mailadres is gekoppeld aan een TREK-account. Log in om te reserveren.",
  'rsvp.error.notFound': "Deze reis accepteert geen inschrijvingen meer.",
