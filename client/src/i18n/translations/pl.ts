const pl: Record<string, string | { name: string; category: string }[]> = {
  ...
  // Navbar
  'nav.trip': 'Podróż',
  'nav.share': 'Udostępnij wycieczkę',
  ...
  'admin.version.prerelease': 'Wersja testowa',
  ...
  // RSVP form
  'rsvp.onTheList': "Jesteś na liście.",
  'rsvp.viewDashboard': "Zobacz wycieczkę w panelu →",
  'rsvp.joining': "Dołączanie...",
  'rsvp.joinTrip': "Dołącz do wycieczki",
  'rsvp.intro': "Stworzymy dla Ciebie konto TREK, abyś mógł/mogła uzyskać dostęp do pełnego itinerarium.",
  'rsvp.alreadyHaveAccount': "Masz już konto? Zaloguj się",
  'rsvp.nameLabel': "Twoje imię i nazwisko",
  'rsvp.namePlaceholder': "Twoje imię i nazwisko",
  'rsvp.emailLabel': "Adres e-mail",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Konto TREK zostanie utworzone przy użyciu tego adresu e-mail.",
  'rsvp.messageLabel': "Wiadomość",
  'rsvp.messageOptional': "(opcjonalne)",
  'rsvp.messagePlaceholder': "Coś, co powinien wiedzieć organizator...",
  'rsvp.feeLabel': "Opłata rejestracyjna: {amount} {currency}",
  'rsvp.feeDeadline': "Termin płatności: {date}.",
  'rsvp.feeInstructions': "Instrukcje płatności zostaną podane przez organizatora wycieczki po rejestracji.",
  'rsvp.logInHere': "Zaloguj się tutaj",
  'rsvp.confirming': "Potwierdzanie...",
  'rsvp.confirmMySpot': "Potwierdź moje miejsce",
  'rsvp.nameRequired': "Imię jest wymagane.",
  'rsvp.emailRequired': "E-mail jest wymagany.",
  'rsvp.paymentSuccess': "🎉 Jesteś zarejestrowany/a! Płatność {amount} {currency} potwierdzona.",
  'rsvp.paypalFeeNotice': "Opłata rejestracyjna: {amount} {currency}. Dokonaj płatności poniżej, aby potwierdzić swoje miejsce.",
  'rsvp.paymentNotCompleted': "Płatność nie została zakończona. Twoja rejestracja nie została zapisana.",
  'rsvp.paymentUnavailable': "Płatność online jest tymczasowo niedostępna. Aby się zarejestrować, skontaktuj się z organizatorem wycieczki.",
  'rsvp.toastJoined': "🎉 Dołączyłeś/aś! Sprawdź swój panel, aby zobaczyć pełne itinerarium.",
  'rsvp.toastRegistered': "🎉 Dołączyłeś/aś! Witamy w TREK — sprawdź swoją skrzynkę.",
  'rsvp.error.duplicateRsvp': "Jesteś już na liście tej wycieczki. Sprawdź swoją skrzynkę odbiorczą.",
  'rsvp.error.emailConflict': "Ten e-mail jest powiązany z kontem TREK. Zaloguj się, aby się zarejestrować.",
  'rsvp.error.notFound': "Ta wycieczka nie przyjmuje już rejestracji.",
  'rsvp.error.tooManyAttempts': "Zbyt wiele prób. Poczekaj kilka minut i spróbuj ponownie.",
  'rsvp.error.serverError': "Coś poszło nie tak po naszej stronie. Spróbuj ponownie za chwilę.",
  'rsvp.error.unknown': "Coś poszło nie tak. Spróbuj ponownie.",
  ...
  'publicTrip.unplanned.subheading': 'Miejsca dodane do tej wycieczki, ale jeszcze niezaplanowane.',

  'places.budgetSelectEntry': 'Select an entry',

  // Public trip page — Accommodation tiers
  'publicTrip.tiers.heading': 'Zakwaterowanie',
  'publicTrip.tiers.subheading': 'Miejsce noclegu zależy od liczby zapisanych osób.',
  'publicTrip.tiers.participants': '{count} potwierdzonych',
  'publicTrip.tiers.nextTier': 'Jeszcze {count}, aby odblokować {name}',
  'publicTrip.tiers.allReached': 'Osiągnięto najwyższy poziom!',
  'publicTrip.tiers.paidNote': 'Liczą się tylko opłacone zapisy.',
  'publicTrip.tiers.active': 'Obecny',
  'publicTrip.tiers.range': '{min}–{max} uczestników',
  'publicTrip.tiers.rangeSingle': '{min} uczestników',
  'publicTrip.tiers.rangeOpen': '{min}+ uczestników',
  'publicTrip.tiers.viewPlace': "Zobacz zakwaterowanie",
  'publicTrip.tiers.viewOnMap': "Pokaż na mapie",

  // Trip form — Accommodation tiers editor
  'tripForm.tiers.heading': "Poziomy zakwaterowania",
  'tripForm.tiers.hint': "Zakwaterowanie zależy od liczby potwierdzonych uczestników (właściciel + zapisy; przy opłacie tylko opłacone). Wyświetlane na publicznej stronie wyjazdu.",
  'tripForm.tiers.status': "{count} potwierdzonych",
  'tripForm.tiers.current': "obecny: {name}",
  'tripForm.tiers.add': "Dodaj poziom",
  'tripForm.tiers.name': "Nazwa",
  'tripForm.tiers.namePlaceholder': "np. Domek Fjellro",
  'tripForm.tiers.minParticipants': "Od liczby uczestników",
  'tripForm.tiers.place': "Miejsce (opcjonalnie)",
  'tripForm.tiers.noPlace': "Brak miejsca",
  'tripForm.tiers.pricePerPerson': "Cena/osoba ({currency})",
  'tripForm.tiers.description': "Opis (opcjonalnie)",
  'tripForm.tiers.nameRequired': "Nazwa jest wymagana",
  'tripForm.tiers.minInvalid': "Liczba uczestników musi być liczbą całkowitą ≥ 1",
  'tripForm.tiers.priceInvalid': "Cena musi wynosić 0 lub więcej",
  'tripForm.tiers.saveError': "Nie udało się zapisać poziomu",
  'tripForm.tiers.deleteError': "Nie udało się usunąć poziomu",
  'tripForm.tiers.confirmDelete': "Usunąć poziom „{name}”?",
}
