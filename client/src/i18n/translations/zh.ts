const zh: Record<string, string> = {
  ...
  // RSVP form
  'rsvp.onTheList': "您已在名单上。",
  'rsvp.viewDashboard': "在控制台查看行程 →",
  'rsvp.joining': "加入中...",
  'rsvp.joinTrip': "加入行程",
  'rsvp.intro': "我们将为您创建一个 TREK 账号，以便访问完整行程。",
  'rsvp.alreadyHaveAccount': "已有账号？登录",
  'rsvp.nameLabel': "您的姓名",
  'rsvp.namePlaceholder': "您的姓名",
  'rsvp.emailLabel': "电子邮件地址",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "将使用此电子邮件地址创建 TREK 账号。",
  'rsvp.messageLabel': "留言",
  'rsvp.messageOptional': "（可选）",
  'rsvp.messagePlaceholder': "您希望组织者了解的信息...",
  'rsvp.feeLabel': "报名费：{amount} {currency}",
  'rsvp.feeDeadline': "付款截止日期：{date}。",
  'rsvp.feeInstructions': "报名后，组织者将提供付款说明。",
  'rsvp.logInHere': "在此登录",
  'rsvp.confirming': "确认中...",
  'rsvp.confirmMySpot': "确认我的名额",
  'rsvp.nameRequired': "姓名为必填项。",
  'rsvp.emailRequired': "电子邮件为必填项。",
  ...
  'rsvp.error.emailConflict': "此邮箱已关联 TREK 账号，请登录后报名。",
  'rsvp.error.notFound': "该行程已停止接受报名。",
  'rsvp.error.tooManyAttempts': "尝试次数过多，请稍后再试。",
  'rsvp.error.serverError': "我们这边出现了问题，请稍后重试。",
  'rsvp.error.unknown': "出现错误，请重试。",
