const es: Record<string, string> = {
  ...
  // RSVP form
  'rsvp.onTheList': "Estás en la lista.",
  'rsvp.viewDashboard': "Ver el viaje en tu panel →",
  'rsvp.joining': "Uniéndose...",
  'rsvp.joinTrip': "Unirse al viaje",
  'rsvp.intro': "Crearemos una cuenta TREK para ti para que puedas acceder al itinerario completo.",
  'rsvp.alreadyHaveAccount': "¿Ya tienes una cuenta? Iniciar sesión",
  'rsvp.nameLabel': "Tu nombre",
  'rsvp.namePlaceholder': "Tu nombre",
  'rsvp.emailLabel': "Dirección de correo electrónico",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Se creará una cuenta TREK usando esta dirección de correo electrónico.",
  'rsvp.messageLabel': "Mensaje",
  'rsvp.messageOptional': "(opcional)",
  'rsvp.messagePlaceholder': "Algo que el organizador debería saber...",
  'rsvp.feeLabel': "Tarifa de inscripción: {amount} {currency}",
  'rsvp.feeDeadline': "Fecha límite de pago: {date}.",
  'rsvp.feeInstructions': "El organizador del viaje proporcionará las instrucciones de pago después de que te registres.",
  'rsvp.logInHere': "Iniciar sesión aquí",
  'rsvp.confirming': "Confirmando...",
  'rsvp.confirmMySpot': "Confirmar mi lugar",
  'rsvp.nameRequired': "El nombre es obligatorio.",
  'rsvp.emailRequired': "El correo electrónico es obligatorio.",
  ...
  'rsvp.error.emailConflict': "Este correo está vinculado a una cuenta TREK. Por favor inicia sesión para reservar.",
  'rsvp.error.notFound': "Este viaje ya no acepta inscripciones.",
  'rsvp.error.tooManyAttempts': "Demasiados intentos. Por favor espera unos minutos antes de intentarlo de nuevo.",
  'rsvp.error.serverError': "Algo salió mal de nuestra parte. Por favor inténtalo de nuevo en breve.",
  'rsvp.error.unknown': "Algo salió mal. Por favor inténtalo de nuevo.",
