const br: Record<string, string | { name: string; category: string }[]> = {
  ...
  // GitHub
  'admin.version.prerelease': 'Pré-lançamento',
  ...
  'packing.toast.duplicated': 'Categoria duplicada',
  'packing.toast.duplicateError': 'Falha ao duplicar categoria',
  ...
  // RSVP form
  'rsvp.onTheList': "Você está na lista.",
  'rsvp.viewDashboard': "Ver a viagem no painel →",
  'rsvp.joining': "Entrando...",
  'rsvp.joinTrip': "Entrar na viagem",
  'rsvp.intro': "Vamos criar uma conta TREK para você acessar o itinerário completo.",
  'rsvp.alreadyHaveAccount': "Já tem uma conta? Entrar",
  'rsvp.nameLabel': "Seu nome",
  'rsvp.namePlaceholder': "Seu nome",
  'rsvp.emailLabel': "Endereço de e-mail",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Uma conta TREK será criada usando este endereço de e-mail.",
  'rsvp.messageLabel': "Mensagem",
  'rsvp.messageOptional': "(opcional)",
  'rsvp.messagePlaceholder': "Algo que o organizador deve saber...",
  'rsvp.feeLabel': "Taxa de inscrição: {amount} {currency}",
  'rsvp.feeDeadline': "Prazo de pagamento: {date}.",
  'rsvp.feeInstructions': "As instruções de pagamento serão fornecidas pelo organizador após o cadastro.",
  'rsvp.logInHere': "Entrar aqui",
  'rsvp.confirming': "Confirmando...",
  'rsvp.confirmMySpot': "Confirmar minha vaga",
  'rsvp.nameRequired': "O nome é obrigatório.",
  'rsvp.emailRequired': "O e-mail é obrigatório.",
  'rsvp.paymentSuccess': "🎉 Você está cadastrado! Pagamento de {amount} {currency} confirmado.",
  'rsvp.paypalFeeNotice': "Taxa de inscrição: {amount} {currency}. Conclua o pagamento abaixo para confirmar sua vaga.",
  'rsvp.paymentNotCompleted': "O pagamento não foi concluído. Seu cadastro não foi salvo.",
  'rsvp.paymentUnavailable': "O pagamento online está temporariamente indisponível. Por favor, entre em contato com o organizador da viagem para se registrar.",
  'rsvp.toastJoined': "🎉 Você entrou! Veja o itinerário completo no seu painel.",
  'rsvp.toastRegistered': "🎉 Você entrou! Bem-vindo ao TREK — verifique sua caixa de entrada.",
  'rsvp.error.duplicateRsvp': "Você já está na lista desta viagem. Verifique sua caixa de entrada.",
  'rsvp.error.emailConflict': "Este e-mail está vinculado a uma conta TREK. Faça login para se inscrever.",
  'rsvp.error.notFound': "Esta viagem não está mais aceitando inscrições.",
  'rsvp.error.tooManyAttempts': "Muitas tentativas. Aguarde alguns minutos antes de tentar novamente.",
  'rsvp.error.serverError': "Algo deu errado do nosso lado. Tente novamente em breve.",
  'rsvp.error.unknown': "Algo deu errado. Tente novamente.",
  ...
  'publicTrip.rsvp.headingMember': "Você está nesta viagem",
  'publicTrip.rsvp.subheadingMember': "Confirmado — acesse seu painel para ver o itinerário completo.",
  'publicTrip.rsvp.headingClosed': "Inscrições encerradas",
  'publicTrip.rsvp.subheadingClosed': "Esta viagem não está mais aceitando novas inscrições.",
  'rsvp.toastPaymentSuccess': "🎉 Você entrou! Bem-vindo ao TREK — verifique sua caixa de entrada para o e-mail de confirmação.",
  'rsvp.authFailedAfterPayment': "Seu pagamento foi recebido, mas não conseguimos conectar você automaticamente. Faça login para ver sua viagem.",

  // Public trip page — Unplanned Activities section
  'publicTrip.unplanned.heading': 'Ideias & Não Planejado',
  'publicTrip.unplanned.subheading': 'Lugares adicionados a esta viagem mas ainda não agendados.',

  'places.budgetSelectEntry': 'Select an entry',

  // Public trip page — Accommodation tiers
  'publicTrip.tiers.heading': 'Hospedagem',
  'publicTrip.tiers.subheading': 'Onde vamos ficar depende de quantas pessoas se inscreverem.',
  'publicTrip.tiers.participants': '{count} confirmados',
  'publicTrip.tiers.nextTier': 'Faltam {count} para desbloquear {name}',
  'publicTrip.tiers.allReached': 'Nível máximo alcançado!',
  'publicTrip.tiers.paidNote': 'Apenas inscrições pagas contam.',
  'publicTrip.tiers.active': 'Atual',
  ...
  'publicTrip.tiers.viewPlace': "Ver hospedagem",
  'publicTrip.tiers.viewOnMap': "Ver no mapa",

  // Trip form — Accommodation tiers editor
  'tripForm.tiers.heading': "Níveis de hospedagem",
  'tripForm.tiers.hint': "A hospedagem depende dos participantes confirmados (organizador + inscrições; apenas pagas quando há taxa). Exibido na página pública da viagem.",
  'tripForm.tiers.status': "{count} confirmados",
  'tripForm.tiers.current': "atual: {name}",
  'tripForm.tiers.add': "Adicionar nível",
  'tripForm.tiers.name': "Nome",
  'tripForm.tiers.namePlaceholder': "ex.: Cabana Fjellro",
  'tripForm.tiers.minParticipants': "A partir de participantes",
  'tripForm.tiers.place': "Local (opcional)",
  'tripForm.tiers.noPlace': "Nenhum local",
  'tripForm.tiers.pricePerPerson': "Preço/pessoa ({currency})",
  'tripForm.tiers.description': "Descrição (opcional)",
  'tripForm.tiers.nameRequired': "O nome é obrigatório",
  'tripForm.tiers.minInvalid': "Participantes deve ser um número inteiro de pelo menos 1",
  'tripForm.tiers.priceInvalid': "O preço deve ser 0 ou mais",
  'tripForm.tiers.saveError': "Não foi possível salvar o nível",
  'tripForm.tiers.deleteError': "Não foi possível excluir o nível",
  'tripForm.tiers.confirmDelete': "Excluir o nível \"{name}\"?",
}
