...
const ar: Record<string, string | { name: string; category: string }[]> = {
  ...
  // RSVP form
  'rsvp.onTheList': "أنت في القائمة.",
  'rsvp.viewDashboard': "عرض الرحلة في لوحة التحكم →",
  'rsvp.joining': "جارٍ الانضمام...",
  'rsvp.joinTrip': "الانضمام إلى الرحلة",
  'rsvp.intro': "سنقوم بإنشاء حساب TREK لك لتتمكن من الوصول إلى البرنامج الكامل.",
  'rsvp.alreadyHaveAccount': "هل لديك حساب بالفعل؟ تسجيل الدخول",
  'rsvp.nameLabel': "اسمك",
  'rsvp.namePlaceholder': "اسمك",
  'rsvp.emailLabel': "عنوان البريد الإلكتروني",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "سيتم إنشاء حساب TREK باستخدام عنوان البريد الإلكتروني هذا.",
  'rsvp.messageLabel': "رسالة",
  'rsvp.messageOptional': "(اختياري)",
  'rsvp.messagePlaceholder': "ما تريد إخبار المنظم به...",
  'rsvp.feeLabel': "رسوم التسجيل: {amount} {currency}",
  'rsvp.feeDeadline': "الموعد النهائي للدفع: {date}.",
  'rsvp.feeInstructions': "ستُقدَّم تعليمات الدفع من قِبَل منظم الرحلة بعد التسجيل.",
  'rsvp.logInHere': "تسجيل الدخول هنا",
  'rsvp.confirming': "جارٍ التأكيد...",
  'rsvp.confirmMySpot': "تأكيد مكاني",
  'rsvp.nameRequired': "الاسم مطلوب.",
  'rsvp.emailRequired': "البريد الإلكتروني مطلوب.",
  ...
  'rsvp.error.emailConflict': "هذا البريد الإلكتروني مرتبط بحساب TREK. يرجى تسجيل الدخول للتسجيل.",
  'rsvp.error.notFound': "هذه الرحلة لم تعد تقبل التسجيلات.",
