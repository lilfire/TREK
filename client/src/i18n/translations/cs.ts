const cs: Record<string, string | { name: string; category: string }[]> = {
  ...
  // RSVP form
  'rsvp.onTheList': "Jste na seznamu.",
  'rsvp.viewDashboard': "Zobrazit cestu na nástěnce →",
  'rsvp.joining': "Přihlašování...",
  'rsvp.joinTrip': "Přidat se k cestě",
  'rsvp.intro': "Vytvoříme vám účet TREK, abyste měli přístup k celému itineráři.",
  'rsvp.alreadyHaveAccount': "Máte již účet? Přihlásit se",
  'rsvp.nameLabel': "Vaše jméno",
  'rsvp.namePlaceholder': "Vaše jméno",
  'rsvp.emailLabel': "E-mailová adresa",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Pomocí této e-mailové adresy bude vytvořen účet TREK.",
  'rsvp.messageLabel': "Zpráva",
  'rsvp.messageOptional': "(volitelné)",
  'rsvp.messagePlaceholder': "Co by měl organizátor vědět...",
  'rsvp.feeLabel': "Registrační poplatek: {amount} {currency}",
  'rsvp.feeDeadline': "Termín platby: {date}.",
  'rsvp.feeInstructions': "Platební instrukce budou poskytnuty organizátorem cesty po registraci.",
  'rsvp.logInHere': "Přihlaste se zde",
  'rsvp.confirming': "Potvrzování...",
  'rsvp.confirmMySpot': "Potvrdit mé místo",
  'rsvp.nameRequired': "Jméno je povinné.",
  'rsvp.emailRequired': "E-mail je povinný.",
  ...
  'rsvp.error.emailConflict': "Tento e-mail je spojen s účtem TREK. Prosím přihlaste se pro rezervaci.",
  'rsvp.error.notFound': "Tato cesta již nepřijímá registrace.",
