const hu: Record<string, string | { name: string; category: string }[]> = {
  ...
  // RSVP form
  'rsvp.onTheList': "Rajta vagy a listán.",
  'rsvp.viewDashboard': "Utazás megtekintése az irányítópulton →",
  'rsvp.joining': "Csatlakozás...",
  'rsvp.joinTrip': "Csatlakozás az utazáshoz",
  'rsvp.intro': "Létrehozunk egy TREK-fiókot számodra, hogy hozzáférj a teljes útvonaltervhez.",
  'rsvp.alreadyHaveAccount': "Már van fiókod? Bejelentkezés",
  'rsvp.nameLabel': "A neved",
  'rsvp.namePlaceholder': "A neved",
  'rsvp.emailLabel': "E-mail cím",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Egy TREK-fiók lesz létrehozva ezzel az e-mail-címmel.",
  'rsvp.messageLabel': "Üzenet",
  'rsvp.messageOptional': "(opcionális)",
  'rsvp.messagePlaceholder': "Amit a szervező tudnia kell...",
  'rsvp.feeLabel': "Regisztrációs díj: {amount} {currency}",
  'rsvp.feeDeadline': "Fizetési határidő: {date}.",
  'rsvp.feeInstructions': "A fizetési utasításokat az utazás szervezője a regisztráció után adja meg.",
  'rsvp.logInHere': "Bejelentkezés itt",
  'rsvp.confirming': "Megerősítés...",
  'rsvp.confirmMySpot': "Helyem megerősítése",
  'rsvp.nameRequired': "A név megadása kötelező.",
  'rsvp.emailRequired': "Az e-mail megadása kötelező.",
  ...
  'rsvp.error.emailConflict': "Ez az e-mail egy TREK-fiókhoz van kapcsolva. Kérjük, jelentkezz be.",
  'rsvp.error.notFound': "Ez az utazás már nem fogad regisztrációkat.",
