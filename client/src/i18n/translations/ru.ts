const ru: Record<string, string> = {
  ...
  // RSVP form
  'rsvp.onTheList': "Вы в списке.",
  'rsvp.viewDashboard': "Просмотреть поездку в панели →",
  'rsvp.joining': "Присоединение...",
  'rsvp.joinTrip': "Присоединиться к поездке",
  'rsvp.intro': "Мы создадим аккаунт TREK для вас, чтобы вы могли получить доступ к полному маршруту.",
  'rsvp.alreadyHaveAccount': "Уже есть аккаунт? Войти",
  'rsvp.nameLabel': "Ваше имя",
  'rsvp.namePlaceholder': "Ваше имя",
  'rsvp.emailLabel': "Адрес электронной почты",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Аккаунт TREK будет создан с использованием этого адреса электронной почты.",
  'rsvp.messageLabel': "Сообщение",
  'rsvp.messageOptional': "(необязательно)",
  'rsvp.messagePlaceholder': "Что должен знать организатор...",
  'rsvp.feeLabel': "Регистрационный взнос: {amount} {currency}",
  'rsvp.feeDeadline': "Срок оплаты: {date}.",
  'rsvp.feeInstructions': "Инструкции по оплате будут предоставлены организатором поездки после регистрации.",
  'rsvp.logInHere': "Войти здесь",
  'rsvp.confirming': "Подтверждение...",
  'rsvp.confirmMySpot': "Подтвердить место",
  'rsvp.nameRequired': "Имя обязательно.",
  'rsvp.emailRequired': "Email обязателен.",
  'rsvp.paymentSuccess': "🎉 Вы зарегистрированы! Платёж {amount} {currency} подтверждён.",
  'rsvp.paypalFeeNotice': "Регистрационный взнос: {amount} {currency}. Завершите оплату ниже для подтверждения места.",
  'rsvp.paymentNotCompleted': "Оплата не была завершена. Ваша регистрация не сохранена.",
  'rsvp.paymentUnavailable': "Онлайн-оплата временно недоступна. Пожалуйста, свяжитесь с организатором поездки для регистрации.",
  'rsvp.toastJoined': "🎉 Вы присоединились! Откройте панель управления для просмотра маршрута.",
  'rsvp.toastRegistered': "🎉 Вы присоединились! Добро пожаловать в TREK — проверьте почту.",
  'rsvp.error.duplicateRsvp': "Вы уже в списке на эту поездку. Проверьте свою почту.",
  'rsvp.error.emailConflict': "Этот email привязан к аккаунту TREK. Войдите для регистрации.",
  'rsvp.error.notFound': "Эта поездка больше не принимает регистрации.",
  ...
  'publicTrip.rsvp.headingMember': "Вы участвуете в этой поездке",
  'publicTrip.rsvp.subheadingMember': "Вы подтверждены — откройте панель управления для просмотра маршрута.",
  'publicTrip.rsvp.headingClosed': "Регистрация закрыта",
  'publicTrip.rsvp.subheadingClosed': "Эта поездка больше не принимает новые регистрации.",
  'rsvp.toastPaymentSuccess': "🎉 Вы присоединились! Добро пожаловать в TREK — проверьте почту для получения письма с подтверждением.",
  'rsvp.authFailedAfterPayment': "Ваш платёж получен, но нам не удалось выполнить автоматический вход. Пожалуйста, войдите в систему для просмотра поездки.",
