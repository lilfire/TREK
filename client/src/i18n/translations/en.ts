const en: Record<string, string | { name: string; category: string }[]> = {
  ...
  'trips.publicVisibilityLabel': 'List this trip on the public page',
  ...
  'settings.about.support': 'Helps me keep building TREK',
  ...
  'places.budgetGroup': 'Budget Group',
  'places.budgetGroupPlaceholder': 'Select a group or type to create one…',
  'places.budgetGroupHelper': 'Optional. Links this activity to a budget category so costs can be tracked.',
  'places.budgetGroupTooltip': 'Choose an existing budget group (e.g. "Food", "Activities") or type a new name to create one. A budget entry will be added automatically when you save.',
  'places.budgetGroupEmpty': 'Type to create your first budget group.',
  ...
  'publicTrip.tiers.heading': 'Accommodation',
  'publicTrip.tiers.subheading': 'Where we stay depends on how many people sign up.',
  'publicTrip.tiers.participants': '{count} confirmed',
  'publicTrip.tiers.nextTier': '{count} more to unlock {name}',
  'publicTrip.tiers.allReached': 'Top tier reached!',
  'publicTrip.tiers.paidNote': 'Only paid registrations count.',
  'publicTrip.tiers.active': 'Current',
  'publicTrip.tiers.range': '{min}–{max} participants',
  'publicTrip.tiers.rangeSingle': '{min} participants',
  'publicTrip.tiers.rangeOpen': '{min}+ participants',
  'publicTrip.tiers.viewPlace': "See the accommodation",
  'publicTrip.tiers.viewOnMap': "View on map",

  // Trip form — Accommodation tiers editor
  'tripForm.tiers.heading': "Accommodation tiers",
  'tripForm.tiers.hint': "Which accommodation applies depends on confirmed participants (owner + registrations; only paid ones when a fee is set). Shown on the public trip page.",
  'tripForm.tiers.status': "{count} confirmed",
  'tripForm.tiers.current': "current: {name}",
  'tripForm.tiers.add': "Add tier",
  'tripForm.tiers.name': "Name",
  'tripForm.tiers.namePlaceholder': "e.g. Cabin Fjellro",
  'tripForm.tiers.minParticipants': "From participants",
  'tripForm.tiers.place': "Place (optional)",
  'tripForm.tiers.noPlace': "No place",
  'tripForm.tiers.pricePerPerson': "Price/person ({currency})",
  'tripForm.tiers.description': "Description (optional)",
  'tripForm.tiers.nameRequired': "Name is required",
  'tripForm.tiers.minInvalid': "Participants must be a whole number of at least 1",
  'tripForm.tiers.priceInvalid': "Price must be 0 or more",
  'tripForm.tiers.saveError': "Could not save tier",
  'tripForm.tiers.deleteError': "Could not delete tier",
  'tripForm.tiers.confirmDelete': "Delete tier \"{name}\"?",
  // Public trip page
  'publicTrip.notFound': 'Trip not found',
  'publicTrip.notFoundMessage': 'This trip is not publicly available.',
  'common.dayCount': '{count} days',
  'common.dayCountOne': '{count} day',
  'publicTrip.readOnly': 'Read-only view',
  'publicTrip.itinerary': 'Itinerary',
  'publicTrip.itineraryAria': 'Trip itinerary',
  'publicTrip.noDays': 'No days planned yet.',
  'common.placeCount': '{count} places',
  'common.placeCountOne': '{count} place',
  'publicTrip.duration.hours': '{count}hr',
  'publicTrip.duration.minutes': '{count}min',
  'publicTrip.theme.light': 'Switch to light mode',
  'publicTrip.theme.dark': 'Switch to dark mode',

  // Public trips list & discover tab
  'publicTrips.title': 'Explore Trips',
  'publicTrips.subtitle': 'Browse publicly shared travel itineraries',
  'publicTrips.empty': 'No public trips yet',
  'publicTrips.emptyHint': 'Check back later — trip planners can make their itineraries public here.',
  'publicTrips.viewTrip': 'View trip: {name}',
  'publicTrips.accountNav': 'Account navigation',
  'publicTrips.poweredBy': 'Powered by',
  'discover.alreadyMember': "You're already on the list for this trip.",
  'discover.joined': "🎉 You've joined the trip! It will appear in My Trips shortly.",
  'discover.empty': 'No public trips to discover right now.',
  'discover.emptyHint': 'Check back later — more trips may be added soon.',

  // Trip form — registration fee & RSVP deadline
  'trips.selectCountry': 'Select country',
  'tripForm.fee.label': 'Registration Fee',
  'tripForm.fee.amountPlaceholder': 'Amount ({currency})',
  'tripForm.fee.type': 'Fee type',
  'tripForm.fee.modeDeadline': 'Inform registrants of a payment deadline',
  'tripForm.fee.modeRsvp': 'Collect payment at registration (PayPal)',
  'tripForm.fee.deadline': 'Payment deadline',
  'tripForm.fee.invalidAmount': 'Registration fee must be a non-negative number',
  'tripForm.fee.typeRequired': 'Please select a fee type',
  'tripForm.fee.deadlineRequired': 'Please select a payment deadline',
  'tripForm.fee.deadlinePast': 'Payment deadline must not be in the past',
  'tripForm.rsvpDeadline': 'RSVP deadline',
  'tripForm.clearDeadline': 'Clear deadline',

  // Admin — demo, OIDC, PayPal, email, JWT
  'admin.demo.title': 'Demo Baseline',
  'admin.demo.hint': 'Save current state as the hourly reset point. All admin trips and settings will be preserved.',
  'admin.demo.save': 'Save Baseline',
  'admin.demo.saved': 'Baseline saved! Resets will restore to this state.',
  'admin.demo.saveError': 'Failed to save baseline',
  'admin.oidcDisplayNamePlaceholder': 'e.g. Google, Authentik, Keycloak',
  'admin.oidcDiscoveryUrl': 'Discovery URL',
  'admin.oidcDiscoveryUrlHint': 'Override the auto-constructed discovery URL. Required for providers like Authentik where the endpoint is not at',
  'admin.paypal.hint': 'Configure PayPal credentials for trip registration fee payments.',
  'admin.paypal.configured': 'Configured',
  'admin.paypal.notConfigured': 'Not configured',
  'admin.paypal.secret': 'Secret',
  'admin.paypal.secretSet': '(currently set — leave blank to keep)',
  'admin.paypal.secretPlaceholder': 'Enter PayPal secret',
  'admin.paypal.mode': 'Mode',
  'admin.paypal.mode.sandbox': 'Sandbox',
  'admin.paypal.mode.live': 'Live',
  'admin.paypal.saved': 'PayPal settings saved',
  'admin.paypal.testConnection': 'Test Connection',
  'admin.paypal.testSuccess': 'Connection successful',
  'admin.paypal.testFailed': 'Connection failed',
  'admin.paypal.requestFailed': 'Request failed',
  'admin.smtp.host': 'SMTP Host',
  'admin.smtp.port': 'SMTP Port',
  'admin.smtp.user': 'SMTP User',
  'admin.smtp.password': 'SMTP Password',
  'admin.smtp.fromAddress': 'From Address',
  'admin.smtp.skipTls': 'Skip TLS certificate check',
  'admin.smtp.skipTlsHint': 'Enable for self-signed certificates on local mail servers',
  'admin.brevo.hint': "Alternative to SMTP — sends through Brevo's servers, no mail server or DNS needed. Takes priority over SMTP when an API key is set.",
  'admin.brevo.apiKey': 'Brevo API Key',
  'admin.brevo.fromName': 'From Name',
  'admin.dangerZone.title': 'Danger Zone',
  'admin.jwt.title': 'Rotate JWT Secret',
  'admin.jwt.hint': 'Generate a new JWT signing secret. All active sessions will be invalidated immediately.',
  'admin.jwt.rotateAndLogout': 'Rotate & Log out',
  'admin.jwt.warning': 'Warning, this will invalidate all sessions and log you out.',
  'admin.jwt.warningDetail': 'A new JWT secret will be generated immediately. Every logged-in user — including you — will be signed out and will need to log in again.',

  // Common — counts & misc
  'common.fileCount': '{count} files',
  'common.fileCountOne': '{count} file',
  'common.photoCount': '{count} photos',
  'common.photoCountOne': '{count} photo',
  ...
  'dayplan.toast.routeError': 'Could not calculate route',
  'places.trackRoute': 'Track / Route',
  'files.maxSize': 'Max {size}',
  'photos.deleteConfirm': 'Delete photo?',
  'map.mapboxTokenMissing': 'No Mapbox access token configured.',
  'map.mapboxTokenMissingHint': 'Settings → Map → Mapbox GL',
  'map.mapboxPreviewHint': 'Enter a Mapbox access token to preview',

  // Collab
  'collab.notes.expand': 'Expand',
  'collab.notes.clickToRename': 'Click to rename',
  'collab.notes.link': 'Link',
  'collab.polls.voteCount': '{count} votes',
  'collab.polls.voteCountOne': '{count} vote',

  // Journey
  'journey.noLocation': 'No location',
  'journey.entry.checkin': 'Check-in',
  'journey.entry.addStory': 'Add your story…',
  'journey.entry.untitled': 'Untitled',
  'journey.entry.onTheMap': 'On the map',
  'journey.entry.thisEntry': 'this entry',
  'journey.detail.moveUp': 'Move up',
  'journey.detail.moveDown': 'Move down',
  'journey.stats.stories': 'Stories',
  'journey.picker.album': 'Album',
  'journey.markdown.bold': 'Bold',
  'journey.markdown.italic': 'Italic',
  'journey.markdown.heading': 'Heading',
  'journey.markdown.quote': 'Quote',
  'journey.markdown.link': 'Link',
  'journey.markdown.list': 'List',
  'journey.markdown.ordered': 'Ordered',
  'journey.markdown.divider': 'Divider',

  // Photos / Immich — EXIF
  'memories.exif.camera': 'Camera',
  'memories.exif.focal': 'Focal',
  'memories.exif.aperture': 'Aperture',
  'memories.exif.shutter': 'Shutter',

  // Settings — offline & integrations
  'offline.title': 'Offline Cache',
  'offline.cachedTrips': 'Cached trips',
  'offline.pendingChanges': 'Pending changes',
  'offline.syncing': 'Syncing…',
  'offline.resync': 'Re-sync now',
  'offline.clearCache': 'Clear cache',
  'offline.clearConfirm': 'Clear all offline trip data? You can re-sync anytime while online.',
  'offline.empty': 'No trips cached yet. Connect to internet to sync.',
  'settings.mcp.deprecated': 'Deprecated',

  // Admin — addons & GitHub
  'admin.addons.comingSoon': 'Coming Soon',

  // OAuth consent page
  'oauth.consent.invalidRequest': 'Invalid authorization request',
  'oauth.consent.validateFailed': 'Failed to validate authorization request. Please try again.',
  'oauth.consent.authorizeFailed': 'Authorization failed. Please try again.',
  'oauth.consent.otherGroup': 'Other',
  'oauth.consent.authorizing': 'Authorizing…',
  'oauth.consent.errorTitle': 'Authorization Error',
  'oauth.consent.signInTitle': 'Sign in to continue',
  'oauth.consent.signInMessage': 'wants access to your TREK account. Please sign in first.',
  'oauth.consent.signInButton': 'Sign in to TREK',
  'oauth.consent.requestTitle': 'Authorization Request',
  'oauth.consent.requestMessage': 'This application is requesting access to your TREK account.',
  'oauth.consent.trustNotice': 'Only grant access to applications you trust. Your data stays on your server.',
  'oauth.consent.selectScope': 'Select at least one scope',
  'oauth.consent.approveScopes': 'Approve ({count} scopes)',
  'oauth.consent.approveScopesOne': 'Approve ({count} scope)',
  'oauth.consent.approve': 'Approve Access',
  'oauth.consent.deny': 'Deny',
  'oauth.consent.chooseScopes': 'Choose which permissions to grant',
  'oauth.consent.scopesRequested': 'Permissions requested',
  'oauth.consent.alwaysIncluded': 'Always included',
  'oauth.consent.listTripsDesc': 'List your trips so the AI can discover trip IDs',
  'oauth.consent.tripSummaryDesc': 'Read a trip overview needed to use any other tool',
}
