const it: Record<string, string | { name: string; category: string }[]> = {
  ...
  'packing.toast.duplicated': 'Categoria duplicata',
  'packing.toast.duplicateError': 'Impossibile duplicare la categoria',
  ...
  // RSVP form
  'rsvp.onTheList': "Sei nella lista.",
  'rsvp.viewDashboard': "Visualizza il viaggio nella tua dashboard →",
  'rsvp.joining': "Iscrizione in corso...",
  'rsvp.joinTrip': "Unisciti al viaggio",
  'rsvp.intro': "Creeremo un account TREK per te così potrai accedere all'itinerario completo.",
  'rsvp.alreadyHaveAccount': "Hai già un account? Accedi",
  'rsvp.nameLabel': "Il tuo nome",
  'rsvp.namePlaceholder': "Il tuo nome",
  'rsvp.emailLabel': "Indirizzo e-mail",
  'rsvp.emailPlaceholder': 'your@email.com',
  'rsvp.accountNotice': "Un account TREK verrà creato con questo indirizzo e-mail.",
  'rsvp.messageLabel': "Messaggio",
  'rsvp.messageOptional': "(facoltativo)",
  'rsvp.messagePlaceholder': "Qualcosa che l'organizzatore dovrebbe sapere...",
  'rsvp.feeLabel': "Quota di iscrizione: {amount} {currency}",
  'rsvp.feeDeadline': "Scadenza pagamento: {date}.",
  'rsvp.feeInstructions': "Le istruzioni per il pagamento saranno fornite dall'organizzatore dopo la registrazione.",
  'rsvp.logInHere': "Accedi qui",
  'rsvp.confirming': "Conferma in corso...",
  'rsvp.confirmMySpot': "Conferma il mio posto",
  'rsvp.nameRequired': "Il nome è obbligatorio.",
  'rsvp.emailRequired': "L'e-mail è obbligatoria.",
  ...
  'rsvp.error.emailConflict': "Questa e-mail è collegata a un account TREK. Accedi per iscriverti.",
  'rsvp.error.notFound': "Questo viaggio non accetta più iscrizioni.",
  ...
  'publicTrip.rsvp.subheading': "Inserisci i tuoi dati qui sotto e riserveremo il tuo posto.",
  'publicTrip.rsvp.headingMember': "Sei in questo viaggio",
  'publicTrip.rsvp.subheadingMember': "Sei confermato — controlla la tua dashboard per vedere l'itinerario completo.",
  'publicTrip.rsvp.headingClosed': "Registrazione chiusa",
  'publicTrip.rsvp.subheadingClosed': "Questo viaggio non accetta più nuove registrazioni.",
  'rsvp.toastPaymentSuccess': "🎉 Sei dentro! Benvenuto su TREK — controlla la tua casella di posta per l'email di conferma.",
  'rsvp.authFailedAfterPayment': "Il tuo pagamento è stato ricevuto ma non siamo riusciti ad autenticarti automaticamente. Accedi per visualizzare il tuo viaggio.",

  // Public trip page — Unplanned Activities section
  'publicTrip.unplanned.heading': 'Idee & Non Pianificato',
  'publicTrip.unplanned.subheading': 'Luoghi aggiunti a questo viaggio ma non ancora pianificati.',

  'places.budgetSelectEntry': 'Select an entry',

  // Public trip page — Accommodation tiers
  'publicTrip.tiers.heading': 'Alloggio',
  'publicTrip.tiers.subheading': 'Dove alloggeremo dipende da quante persone si iscrivono.',
  'publicTrip.tiers.participants': '{count} confermati',
  'publicTrip.tiers.nextTier': 'Ancora {count} per sbloccare {name}',
  'publicTrip.tiers.allReached': 'Livello massimo raggiunto!',
  'publicTrip.tiers.paidNote': 'Contano solo le iscrizioni pagate.',
  'publicTrip.tiers.active': 'Attuale',
  'publicTrip.tiers.range': '{min}–{max} partecipanti',
  'publicTrip.tiers.rangeSingle': '{min} partecipanti',
  'publicTrip.tiers.rangeOpen': '{min}+ partecipanti',
  'publicTrip.tiers.viewPlace': "Vedi l'alloggio",
  'publicTrip.tiers.viewOnMap': "Vedi sulla mappa",

  // Trip form — Accommodation tiers editor
  'tripForm.tiers.heading': "Livelli di alloggio",
  'tripForm.tiers.hint': "L'alloggio dipende dai partecipanti confermati (proprietario + iscrizioni; solo pagate se c'è una quota). Mostrato nella pagina pubblica del viaggio.",
  'tripForm.tiers.status': "{count} confermati",
  'tripForm.tiers.current': "attuale: {name}",
  'tripForm.tiers.add': "Aggiungi livello",
  'tripForm.tiers.name': "Nome",
  'tripForm.tiers.namePlaceholder': "es. Baita Fjellro",
  'tripForm.tiers.minParticipants': "Da partecipanti",
  'tripForm.tiers.place': "Luogo (facoltativo)",
  'tripForm.tiers.noPlace': "Nessun luogo",
  'tripForm.tiers.pricePerPerson': "Prezzo/persona ({currency})",
  'tripForm.tiers.description': "Descrizione (facoltativa)",
  'tripForm.tiers.nameRequired': "Il nome è obbligatorio",
  'tripForm.tiers.minInvalid': "I partecipanti devono essere un numero intero di almeno 1",
  'tripForm.tiers.priceInvalid': "Il prezzo deve essere 0 o più",
  'tripForm.tiers.saveError': "Impossibile salvare il livello",
  'tripForm.tiers.deleteError': "Impossibile eliminare il livello",
  'tripForm.tiers.confirmDelete': "Eliminare il livello \"{name}\"?",
}
