...
const texts: Record<string, DemoTexts> = {
  ...
  nb: {
    titleBefore: 'Velkommen til ',
    titleAfter: '',
    title: 'Velkommen til TREK-demoen',
    description: 'Du kan se, redigere og opprette turer. Alle endringer tilbakestilles automatisk hver time.',
    resetIn: 'Neste tilbakestilling om',
    minutes: 'minutter',
    uploadNote: 'Filopplasting (bilder, dokumenter, forsidebilder) er deaktivert i demomodus.',
    fullVersionTitle: 'I tillegg i fullversjonen:',
    features: [
      'Filopplasting (bilder, dokumenter, forsidebilder)',
      'Administrasjon av API-nøkler (Google Maps, vær)',
      'Bruker- og tillatelsesadministrasjon',
      'Automatiske sikkerhetskopier',
      'Administrasjon av tillegg (slå på/av)',
      'OIDC / SSO-innlogging',
    ],
    addonsTitle: 'Modulære tillegg (kan deaktiveres i fullversjonen)',
    addons: [
      ['Vacay', 'Ferieplanlegger med kalender, helligdager og brukersammenslåing'],
      ['Atlas', 'Verdenskart med besøkte land og reisestatistikk'],
      ['Pakking', 'Sjekklister per tur'],
      ['Budsjett', 'Utgiftsoversikt med fordeling'],
      ['Dokumenter', 'Legg ved filer på turer'],
      ['Widgets', 'Valutakalkulator og tidssoner'],
    ],
    whatIs: 'Hva er TREK?',
    whatIsDesc: 'En selvhostet reiseplanlegger med sanntidssamarbeid, interaktive kart, OIDC-innlogging og mørk modus.',
    selfHost: 'Åpen kildekode — ',
    selfHostLink: 'host den selv',
    close: 'Skjønner',
  },
  es: {
