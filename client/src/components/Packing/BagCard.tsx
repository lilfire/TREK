...
interface BagCardProps {
  ...
  canEdit: boolean
  onDelete: () => void
  onUpdate: (bagId: number, data: Record<string, unknown>) => void
  onSetMembers: (bagId: number, userIds: number[]) => void
  t: (key: string, params?: Record<string, string | number | null>) => string
  compact?: boolean
}

export default function BagCard({ bag, bagItems, totalWeight, pct, tripMembers, canEdit, onDelete, onUpdate, onSetMembers, t, compact }: BagCardProps) {
