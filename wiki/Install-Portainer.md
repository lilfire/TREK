...
3. Select **Web editor** and paste the compose file from [docker-compose.yml](https://github.com/lilfire/TREK/blob/main/docker-compose.yml).
...
See https://github.com/lilfire/TREK/blob/main/docker-compose.yml
...
|---|---|---|
| `latest` | `ghcr.io/lilfire/trek:latest` | Always the newest release across all major versions |
| Major version | `ghcr.io/lilfire/trek:3` | Latest release pinned to that major version |
| Full version | `ghcr.io/lilfire/trek:3.0.15` | Exact release; never changes |
